/**
 * 拉取 Pokemon HOME 朱紫对战使用率数据（级别对战 + 官方大赛）
 *
 ...
 *   scvi/{cId}/pdetail.json    → 宝可梦详情（招式/道具/性格/搬伴）
 *
 * 用法:
 *   node scripts/fetch-battle-usage.mjs
 *   node scripts/fetch-battle-usage.mjs --force   # 强制重新拉取已缓存条目
 */
...
for (const [cId, entry] of Object.entries(internetData.list)) {
  // soft 数组第 39 位 (index) 是 Sc，40 是 Vi
